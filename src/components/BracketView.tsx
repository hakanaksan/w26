            ...
            <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
              <div className="flex items-center gap-3">
                <div className="px-3 py-1 rounded-lg text-sm font-bold text-white bg-gradient-to-r from-purple-500 to-indigo-600 shadow-sm">
                  En İyi Üçüncüler Sıralaması
                </div>
                <span className="text-xs text-gray-500 dark:text-gray-400">Grup üçüncülerinin karşılaştırılması</span>
              </div>
                  ...
                  <tbody>
                    {bestThirds.map((team, idx) => {
                      ...
                      return (
                        <tr
                          key={team.code}
                          className={`border-b border-gray-100 dark:border-gray-700 transition-colors hover:bg-gray-50 dark:hover:bg-gray-750/50 ${
